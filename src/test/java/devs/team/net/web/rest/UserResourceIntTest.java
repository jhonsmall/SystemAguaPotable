...
import devs.team.net.config.CacheConfiguration;
import devs.team.net.domain.Authority;
import devs.team.net.domain.User;
import devs.team.net.repository.UserRepository;
import devs.team.net.repository.search.UserSearchRepository;
import devs.team.net.security.AuthoritiesConstants;
import devs.team.net.service.MailService;
import devs.team.net.service.UserService;
import devs.team.net.service.dto.UserDTO;
import devs.team.net.service.mapper.UserMapper;
import devs.team.net.web.rest.errors.ExceptionTranslator;
import devs.team.net.web.rest.vm.ManagedUserVM;
