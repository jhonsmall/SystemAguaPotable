...
/**
 * Performance test for the Recibo entity.
 */
class ReciboGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Recibo entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created recibo")
                .get("${new_recibo_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created recibo")
            .delete("${new_recibo_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
